...
public class BalanceView extends View {
    ...
    private void init(){
        expensePaint.setColor(ContextCompat.getColor(getContext(), R.color.lightish_blue));
        incomePaint.setColor(ContextCompat.getColor(getContext(), R.color.colorGreen));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(xMargin - space, yMargin, getWidth() - xMargin - space,
                getHeight() - yMargin, 180 - expenseAngle / 2, expenseAngle, true,
                expensePaint);

        canvas.drawArc(xMargin + space, yMargin, getWidth() - xMargin + space,
                getWidth() - yMargin, 360 - incomesAngle / 2,
